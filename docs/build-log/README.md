...
- Completed log entries: PR1-PR30 (PR20 reserved for numbering reconciliation, PR27 process-only).
- Next target increment: context threading, security hardening, then transport wiring.
