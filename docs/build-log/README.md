...
- Completed log entries: PR1-PR29 (PR20 reserved for numbering reconciliation, PR27 process-only).
- Next target increment: test flakiness fixes, then transport wiring for storage simulation mutation calls.
