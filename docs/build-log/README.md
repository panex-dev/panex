...
- Completed log entries: PR1-PR31 (PR20 reserved for numbering reconciliation, PR27 process-only).
- Next target increment: security hardening (origin validation, auth header), then transport wiring.
